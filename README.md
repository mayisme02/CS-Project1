...
This demo showcases **Tracky PeT**, an IoT-based mobile application for real-time pet tracking.

[![TrackyPeT Demo](https://img.youtube.com/vi/4GAi_3uEM_E/0.jpg)](https://youtu.be/4GAi_3uEM_E)
