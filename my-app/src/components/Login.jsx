    ...
    <div className="login-container">
      <div className="login-card">
        ...
        <form onSubmit={handleEmailLogin}>
          <input type="email" placeholder="Email Address" ref={emailRef} disabled={isCooldown} />
          <input type="password" placeholder="Password" ref={passwordRef} disabled={isCooldown} />
          ...
          <button type="submit" className="btn btn-login" disabled={isCooldown}>
        ...
        <button className="btn btn-google" onClick={handleGoogleLogin} disabled={isCooldown}>
          <img src="/google-icon.png" alt="Google" /> Login with Google
        </button>

        <button className="btn btn-facebook" onClick={handleFacebookLogin} disabled={isCooldown}>
